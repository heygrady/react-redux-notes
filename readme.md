...
### High-level Concepts
It's important to get a picture of how a starter-kit app is structured because it makes it clear how to apply the core principles of React-Redux. At it's core React-Redux is a marriage of components (React) with a store (Redux). Most people get a little lost at this point so here's a quick example using a plain React component.
